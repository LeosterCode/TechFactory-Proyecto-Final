...
export default function TechFactory() {
    return (
        <section className="container queEs p-md-5 p-1" id='queEs'>
            <div className="row d-md-inline d-flex flex-column justify-content-center align-items-center">
                
                <h2 className='textHeader mb-md-1 mb-0 text-center'>¿Qué es TechFactory?</h2>
